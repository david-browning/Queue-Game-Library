...
namespace QGL_Math_Unit_Tests
{
   TEST_CLASS(BoundaryTests)
   {
      ...
      {
         boundary<int, boundary_y_axis::y_down_positive> b;
      ...
      {
         RECT r{ 1, 2, 3, 4 };
         auto b = boundary<LONG, boundary_y_axis::y_down_positive>{ r };
      ...
      TEST_METHOD(RECTIntersectConstructor)
      {
         RECT b1{ 1, 1, 4, 4 };
         RECT b2{ 3, 0, 5, 5 };
         boundary<int, boundary_y_axis::y_down_positive> intersect{ b1, b2 };
      ...
      {
         boundary<int, boundary_y_axis::y_down_positive> b1{ 1, 1, 4, 4 };
         boundary<int, boundary_y_axis::y_down_positive> b2{ 1, 1, 2, 2 };
         boundary<int, boundary_y_axis::y_down_positive> intersect{ b1, b2 };
      ...
      {
         boundary<int, boundary_y_axis::y_down_positive> b1{ 1, 1, 4, 4 };
         boundary<int, boundary_y_axis::y_down_positive> b2{ 3, 0, 5, 5 };
         boundary<int, boundary_y_axis::y_down_positive> intersect{ b1, b2 };
      ...
      {
         boundary<int, boundary_y_axis::y_down_negative> b1{ 1, 5, 3, 1 };
         boundary<int, boundary_y_axis::y_down_negative> b2{ 2, 3, 4, 1 };
         boundary<int, boundary_y_axis::y_down_negative> intersect{ b1, b2 };
      ...
      {
         RECT r{ 1, 2, 3, 4 };
         auto b1 = boundary<LONG, boundary_y_axis::y_down_positive>{ r };
         boundary<LONG, boundary_y_axis::y_down_positive> b{ b1 };
      ...
      TEST_METHOD(MoveConstructor)
      {
         RECT r{ 1, 2, 3, 4 };
         auto b1 = boundary<LONG, boundary_y_axis::y_down_positive>{ r };
         boundary<LONG, boundary_y_axis::y_down_positive> b{ std::move(b1) };
      ...
      TEST_METHOD(Intersection)
      {
         ...
         boundary<int, boundary_y_axis::y_down_positive> b3{ 6, 6, 8, 8 };
