...
namespace winrt::QGL_Projection::implementation
{
    struct ContentProject : ContentProjectT<ContentProject>
    {
        ...
        Windows::Foundation::IAsyncOperation<bool> LoadFromFileAsync(Windows::Storage::StorageFile const f, Windows::Foundation::Collections::IVector<QGL_Projection::ResourceType> const supported);
