...
namespace qgl::math::random
{
   ...
   {
      return qgl_default_random_engine(seed);
   }
   ...
   decltype(auto) choose(const ContainerT& container)
   {
   ...
   decltype(auto) choose(RandomIt first, RandomIt last)
   {
