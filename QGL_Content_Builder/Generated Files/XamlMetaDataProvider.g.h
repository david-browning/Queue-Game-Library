...
struct WINRT_EBO XamlMetaDataProvider_base : implements<D, Windows::UI::Xaml::Markup::IXamlMetadataProvider, I...>
{
    ...
    using class_type = QGL_Content_Builder::XamlMetaDataProvider;
    ...
    {
        return L"QGL_Content_Builder.XamlMetaDataProvider";
    }
};
...
{
    using instance_type = QGL_Content_Builder::XamlMetaDataProvider;
