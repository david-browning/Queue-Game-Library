...
template <> struct category<QGL_Projection::XamlMetaDataProvider>{ using type = class_category; };
...
template <> struct name<QGL_Projection::XamlMetaDataProvider>{ static constexpr auto & value{ L"QGL_Projection.XamlMetaDataProvider" }; };
...
template <> struct default_interface<QGL_Projection::XamlMetaDataProvider>{ using type = Windows::UI::Xaml::Markup::IXamlMetadataProvider; };
