...
#include "include/Content/Content-Descriptors/qgl_texture_descriptor.h"
...
namespace qgl::graphics
{
      ...
      igpu_resource>
   {
      ...
      {
         field_constructor(desc, dev_p);

         switch (desc.type)
         {
            case texture_types::dds:
            {
      ...
      texture(const descriptors::texture_descriptor& desc,
              ...
              gpu::igpu_allocator& allocator,
              i3d_device* dev_p) :
         texture(desc, filePath.c_str(), allocator, dev_p)
      {
                             ...
                             i3d_device* dev_p)
      {
         ...
         if (!DirectX::IsSupportedTexture(dev_p, m_img.GetMetadata()))
         {
