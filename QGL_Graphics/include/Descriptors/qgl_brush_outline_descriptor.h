...
namespace qgl::descriptors
{
    ...
    */
   enum class outline_cap_styles : uint8_t
   {
      /*
    ...
    */
   enum class outline_dash_styles : uint8_t
   {
      /*
    ...
    */
   enum class outline_join_styles : uint8_t
   {
      /*
    ...
    */
#pragma pack(push, 1)
   struct outline_descriptor final
   {
      constexpr outline_descriptor()
      {

      }

      constexpr outline_descriptor(const outline_descriptor&) = default;

      constexpr outline_descriptor(outline_descriptor&&) noexcept = default;

      ~outline_descriptor() noexcept = default;

      friend void swap(
         outline_descriptor& l, 
         outline_descriptor& r) noexcept
      {
         using std::swap;
      ...
      outline_descriptor& operator=(outline_descriptor r) noexcept
      {
         swap(*this, r);
         return *this;
      }
       ...
       */
      outline_cap_styles cap = outline_cap_styles::none;

      /*
       How to draw the stroke.
       */
      outline_dash_styles style = outline_dash_styles::solid;

      /*
       How to join strokes.
       */
      outline_join_styles join = outline_join_styles::miter;
