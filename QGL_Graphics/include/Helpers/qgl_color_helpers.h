...
namespace qgl::graphics::helpers
{
    ...
    */
   extern QGL_GRAPHICS_API bool support_hdr(IDXGIOutput6* output_p);
   ...
   extern QGL_GRAPHICS_API bool color_supported(
      DXGI_COLOR_SPACE_TYPE spc, swap_chain* sc_p);


   inline void set_hdr(const gpu_config& config, swap_chain* swpChain_p)
   {
      switch (config.hdr_mode())
      {
         case hdr_modes::hdr10:
         {
            ...
            swpChain_p->SetHDRMetaData(DXGI_HDR_METADATA_TYPE_HDR10,
         ...
         case hdr_modes::hdr10_plus:
         {
            ...
            swpChain_p->SetHDRMetaData(DXGI_HDR_METADATA_TYPE_HDR10PLUS,
