...
namespace qgl::graphics::gpu
{
    ...
    */
   template<class T>
   class const_buffer : public igpu_buffer<nullptr_t,
                        ...
                        public imappable<T>
   {
         ...
         m_allocator_p(allocator_sp)
      {
         ...
         m_alloc_h = m_allocator_p->alloc(rscDesc);

         auto res_p = allocator_sp->get(m_alloc_h);
      ...
      virtual void map()
      {
         ...
         if (!mapped())
         {
            auto resource = m_allocator_p->get(m_alloc_h);
