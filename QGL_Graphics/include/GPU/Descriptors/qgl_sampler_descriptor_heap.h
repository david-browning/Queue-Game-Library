...
{
   class QGL_GRAPHICS_API sampler_descriptor_heap :
      public descriptor_heap<D3D12_DESCRIPTOR_HEAP_TYPE_SAMPLER,
      D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE>
   {
      public:
      sampler_descriptor_heap(d3d_device* dev_p,
                              size_t numEntries,
                              UINT nodeMask = 0);

      sampler_descriptor_heap(const sampler_descriptor_heap&) = default;
