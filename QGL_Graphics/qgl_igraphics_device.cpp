...
namespace qgl::graphics
{
   ...
   struct graphics_device_0_1 : public igraphics_device
   {
      ...
      virtual void reset(const content::graphics_config* newConfig)
      {
      ...
      virtual const content::graphics_config* config() const noexcept
      {
         return &m_config;
      }

      virtual const d3d_device* d3d12_device() const noexcept
      {
      ...
      virtual const d3d11_device* d3d11on12_device() const noexcept
      {
      ...
      virtual const d2d_context* d2d1_context() const noexcept
      {
      ...
      virtual const d3d11_context* d3d11on12_context() const noexcept
      {
      ...
      virtual const d2d_factory* d2d1_factory() const noexcept
      {
      ...
      virtual const d3d_cmd_queue* cmd_queue() const noexcept
      {
      ...
      virtual const d3d_swap_chain* swap_chain() const noexcept
      {
      ...
      virtual const dxgi_factory* dx_factory() const noexcept
      {
      ...
      virtual const IDXGIAdapter4* adapter() const noexcept
      {
      ...
      */
      ...
      content::graphics_config m_config;
