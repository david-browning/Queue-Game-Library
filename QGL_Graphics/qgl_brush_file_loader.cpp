...
namespace qgl::content::loaders
{
...

   {
      ...
      check_loader_and_resource<RESOURCE_TYPES::RESOURCE_TYPE_DESCRIPTION,
         CONTENT_LOADER_IDS::CONTENT_LOADER_ID_BRUSH>(entry->metadata());

      static struct_importer<buffers::BRUSH_BUFFER,
         RESOURCE_TYPES::RESOURCE_TYPE_DESCRIPTION,
         CONTENT_LOADER_IDS::CONTENT_LOADER_ID_BRUSH> importer;
