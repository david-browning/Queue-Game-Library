...
int32_t WINRT_CALL WINRT_GetActivationFactory(void* classId, void** factory) noexcept
{
    try
    {
        *factory = nullptr;
        ...
        if (requal(name, L"QGL_Graphics.QGL_GraphicsRT"))
        {
            *factory = winrt::detach_abi(winrt::make<winrt::QGL_Graphics::factory_implementation::QGL_GraphicsRT>());
            return 0;
        }
