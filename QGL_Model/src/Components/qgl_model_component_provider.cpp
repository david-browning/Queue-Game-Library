...
/*
 Version 1.0 component provider. Provides the components for the QGL_Modeul
 module.
 */
class component_provider_1_0 : public components::icomponent_provider
{
   ...
   private:
   std::vector<qgl::qgl_unique_ptr<components::icomponent_metadata>> m_metadatas;
};

result_t QGL_CC qgl::components::qgl_get_components(
   qgl_version v, components::icomponent_provider** out_p) noexcept
{
   if (!out_p)
   {
      return E_INVALIDARG;
