...
namespace qgl
{
   ...
   static constexpr qgl_version_t QGL_VERSION_0_1_WIN = make_win_version(QGL_VERSION_MAJOR_0, 
                                                                         QGL_VERSION_MINOR_1);

   static constexpr qgl_version_t QGL_VERSION_0_2_WIN = make_win_version(QGL_VERSION_MAJOR_0,
                                                                         2);
}