...
int32_t WINRT_CALL WINRT_GetActivationFactory(void* classId, void** factory) noexcept
{
    try
    {
        *factory = nullptr;
        ...
        if (requal(name, L"QGL_Content.QGL_ContentRT"))
        {
            *factory = winrt::detach_abi(winrt::make<winrt::QGL_Content::factory_implementation::QGL_ContentRT>());
            return 0;
        }
